...
public class RenderingSystem extends IteratingSystem {
	static final float FRUSTUM_HEIGHT = 75;
	public static final float PIXELS_TO_METRES = FRUSTUM_HEIGHT/Assets.h;
	static final float FRUSTUM_WIDTH = Assets.w*PIXELS_TO_METRES;
